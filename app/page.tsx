...
const page = () => {
  return (
    <>
      <div className="flex flex-col items-center justify-center px-6 pt-8 mx-auto md:h-screen pt:mt-0 dark:bg-gray-900 login-body">


        <div className="w-full max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow dark:bg-gray-800">
        <a href="/login" className="flex items-center justify-center mb-8 text-2xl font-semibold lg:mb-10 dark:text-white">
          <img src="logo.png" className="mr-4" style={{height:"10rem"}} alt="Stanbic Bank Uganda" />
          {/* <span>CIMS CVU</span> */}
        </a>
